...
const destinations = [
  ...
  {
    name: "Diyasaru Park",
    description: "Camp in an urban wetland surrounded by nature trails, birds, and calm lake views",
  ...
  },
  {
    ...
    description: "Camp beside a rainforest waterfall perfect for a refreshing dip and photos.",
  ...
  },
  {
    ...
    description: "Experience lush mangroves, boat rides, and peaceful nature just outside the city.",
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="mt-8 mb-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Camping Destinations</h2>
          <p className="text-gray-600 text-base max-w-2xl leading-relaxed">
            Discover breathtaking spots for your next outdoor adventure,<br/>
            whether you're pitching a tent by waterfalls or
            watching the stars from highland peaks.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {destinations.map((dest, idx) => (
            <DestinationCard
              ...
              onCardClick={dest.name === "Horton Plains" ? () => { navigate("/individual-destination"); window.scrollTo(0, 0); } : undefined}
            />
          ))}
        </div>
        {/* Show All Destinations Button */}
        <div className="flex justify-center mt-10">
          <Button variant="outline" size="md">Show All Destinations</Button>
        </div>
