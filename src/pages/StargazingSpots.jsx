...
const stargazingSpots = [
  ...
  },
  {
    ...
    description: "Primal stargazing experience with wildlife sounds under dark skies.",
  ...
  },
  {
    ...
    description: "Panoramic views with minimal light pollution and magical cloud inversions.",
  ...
  {
    name: "Minneriya Area",
    description: "Starry reflections over tank waters and nearby elephant gatherings.",
    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="mt-8 mb-6">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Stargazing Spots</h2>
          <p className="text-gray-600 text-base max-w-2xl leading-relaxed">
            Discover breathtaking spots for your next outdoor adventure , whether you're pitching a tent by waterfalls or watching the stars from highland peaks
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {stargazingSpots.map((spot, idx) => (
            <DestinationCard
              ...
              onCardClick={spot.name === "Horton Plains" ? () => { navigate("/individual-destination"); window.scrollTo(0, 0); } : undefined}
            />
          ))}
        </div>
